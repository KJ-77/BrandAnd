    ...
    <div className="bg-black min-h-screen">
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0">
          ...
          />
          {/* Slight overlay for better text readability if navbar text is on it */}
          <div className="absolute inset-0 bg-black/20"></div>
        </div>

        {/* Note: Navigation component will be rendered by parent layout */}
        {/* The Navigation component should have transparent background for this page */}
      </section>
