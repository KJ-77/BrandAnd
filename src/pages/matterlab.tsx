...
// ===== PROJECT IMAGES =====
import banner from "@/assets/projects/matterlab/banner.webp";
...
import bookletStack from "@/assets/projects/matterlab/booklet-stack.webp";
// ==========================
...
const projectData: ProjectData = {
  ...
  images: [
    ...
    { src: letterheads, alt: "Matterlab letterheads across the brand palette", rowSpan: 5, column: 1 },

    // Right column
    { src: brochurePoster, alt: "Matterlab brochure and poster", rowSpan: 5, column: 2 },
    { src: bookletStack, alt: "Stack of Matterlab booklets", rowSpan: 5, column: 2 },
  ],
};
